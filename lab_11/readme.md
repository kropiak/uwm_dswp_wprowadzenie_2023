...
> Dokumentacja: https://docs.python.org/3.11/library/re.html
> Tutorial: https://docs.python.org/3.11/howto/regex.html#regex-howto
...
# rozbijając na elementy:
# [0-9\s] - zbiór wartości od 0-9 lub whitespace
# + jeden lub więcej razy
# [.,] . lub , jako separator liczby
# [0-9]+ - cyfra jeden lub więcej razy
...
# inne przykłady
wzorzec = 'Dzisiaj jest 18.05.2023 rok. Urodziny mają: Aleksandra, Alicja, Eryk, Eryka, Eufrazja, Faina, Feliks, Jan, Julita, Klaudia, Liberiusz, Matrona, Myślibor, Sandra, Teodot i Wenancjusz.'
...
>Dokumentacja: https://docs.python.org/3.11/library/pickle.html
